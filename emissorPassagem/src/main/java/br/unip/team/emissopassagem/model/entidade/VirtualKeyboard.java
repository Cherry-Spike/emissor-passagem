...
public class VirtualKeyboard implements FocusListener {
    ...
    private final Key ACUTE_KEY = new Key(KeyEvent.VK_DEAD_ACUTE, "ﾂｴ", "`");
    ...
    private Key[] row3 = new Key[]{
        ...
        new Key(KeyEvent.VK_L, "l"), new Key(KeyEvent.VK_DEAD_CEDILLA, "ﾃｧ"),
                ...
                switch (key.keyCode) {
                    case KeyEvent.VK_A:
                        keyString = accentuationBuffer
                                == ACUTE_KEY ? "ﾃ｡"
                                        : accentuationBuffer == GRAVE_KEY ? "ﾃ�"
                                                : accentuationBuffer == TILDE_CIRCUMFLEX_KEY ? "ﾃ｣"
                                                        : accentuationBuffer == CIRCUMFLEX_KEY ? "ﾃ｢" : key.value;
                        break;
                    case KeyEvent.VK_E:
                        keyString = accentuationBuffer
                                == ACUTE_KEY ? "ﾃｩ"
                                        : accentuationBuffer == GRAVE_KEY ? "ﾃｨ"
                                                : accentuationBuffer == TILDE_CIRCUMFLEX_KEY ? "~e"
                                                        : accentuationBuffer == CIRCUMFLEX_KEY ? "ﾃｪ" : key.value;
                        break;
                    case KeyEvent.VK_I:
                        keyString = accentuationBuffer
                                == ACUTE_KEY ? "ﾃｭ"
                                        : accentuationBuffer == GRAVE_KEY ? "ﾃｬ"
                                                : accentuationBuffer == TILDE_CIRCUMFLEX_KEY ? "~i"
                                                        : accentuationBuffer == CIRCUMFLEX_KEY ? "ﾃｮ" : key.value;
                        break;
                    case KeyEvent.VK_O:
                        keyString = accentuationBuffer
                                == ACUTE_KEY ? "ﾃｳ"
                                        : accentuationBuffer == GRAVE_KEY ? "ﾃｲ"
                                                : accentuationBuffer == TILDE_CIRCUMFLEX_KEY ? "ﾃｵ"
                                                        : accentuationBuffer == CIRCUMFLEX_KEY ? "ﾃｴ" : key.value;
                        break;
                    case KeyEvent.VK_U:
                        keyString = accentuationBuffer
                                == ACUTE_KEY ? "ﾃｺ"
                                        : accentuationBuffer == GRAVE_KEY ? "ﾃｹ"
                                                : accentuationBuffer == TILDE_CIRCUMFLEX_KEY ? "~u"
                                                        : accentuationBuffer == CIRCUMFLEX_KEY ? "ﾃｻ" : key.value;
                    default:
                        keyString = key.value;
                        break;
                }
